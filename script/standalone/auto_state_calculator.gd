...
func add_ephemeral_effect(new_effect: AutoStateEffect, priority: float = 0.0, duration: float = -1.0):
	new_effect._effect_ephemeral = true
...
## It is recommended to model permanent stats as an effect, rather than having calculators
